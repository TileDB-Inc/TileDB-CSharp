...
swig -c++ -csharp -namespace TileDB -cpperraswarn    -w462,317,401  -I./ -I../cpp/src/tiledb/cxx_api   -outdir ../csharp/csharp_wrapper/ -o ../cpp/src/tiledb_csharp_cpp_wrapper.cxx   swig_tiledb.i
