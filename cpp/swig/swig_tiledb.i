...
//ignore class or methods in file:../src/tiledb/cxx_api/tiledb_cxx_array.h
...
//ignore class or methods in file:../src/tiledb/cxx_api/tiledb_cxx_array_schema.h
...
//ignore class or methods in file:../src/tiledb/cxx_api/tiledb_cxx_array_util.h
%ignore tiledb::ArrayUtil::operator=(const tiledb::ArrayUtil &);

//ignore class or methods in file:../src/tiledb/cxx_api/tiledb_cxx_attribute.h
...
//ignore class or methods in file:../src/tiledb/cxx_api/tiledb_cxx_context.h
%ignore tiledb::Context::ptr();
%ignore tiledb::Context::set_error_handler(const std::function<void ( const std::string & )> &);

//ignore class or methods in file:../src/tiledb/cxx_api/tiledb_cxx_dimension.h
...
//ignore class or methods in file:../src/tiledb/cxx_api/tiledb_cxx_domain.h
...
//ignore class or methods in file:../src/tiledb/cxx_api/tiledb_cxx_filter_list.h
...
//ignore class or methods in file:../src/tiledb/cxx_api/tiledb_cxx_group.h

//ignore class or methods in file:../src/tiledb/cxx_api/tiledb_cxx_query.h
...
//ignore class or methods in file:../src/tiledb/cxx_api/tiledb_cxx_stats.h

//ignore class or methods in file:../src/tiledb/cxx_api/tiledb_cxx_version.h

//ignore class or methods in file:../src/tiledb/cxx_api/tiledb_cxx_vfs.h
%ignore VFSFilebuf;
