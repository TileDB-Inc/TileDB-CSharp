...
{
    /// <summary>
    /// Summary description for SparseArrayTest
    /// </summary>
    [TestClass]
    public class SparseArrayTest
    {
        ...
        private void CreateSimpleSparseArray()
        {
        ...
        private tiledb.Query.Status WriteSimpleSparseArray()
        {
            tiledb.Context ctx = new tiledb.Context();
        ...
        }//private void WriteSimpleSparseArray()
        ...
        [TestMethod]
        public void TestSimpleSparseArray()
        {
            CreateSimpleSparseArray();
            tiledb.Query.Status status_write = WriteSimpleSparseArray();
            if (status_write == tiledb.Query.Status.FAILED)
            {
                Assert.Fail();
            }
            tiledb.Query.Status status_read = ReadSimpleSparseArray();
