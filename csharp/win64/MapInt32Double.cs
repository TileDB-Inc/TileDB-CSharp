...
public class MapInt32Double : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<int, double>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          tiledbPINVOKE.delete_MapInt32Double(swigCPtr);
        }
  ...
  public MapInt32Double() : this(tiledbPINVOKE.new_MapInt32Double__SWIG_0(), true) {
  }

  public MapInt32Double(MapInt32Double other) : this(tiledbPINVOKE.new_MapInt32Double__SWIG_1(MapInt32Double.getCPtr(other)), true) {
    if (tiledbPINVOKE.SWIGPendingException.Pending) throw tiledbPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = tiledbPINVOKE.MapInt32Double_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = tiledbPINVOKE.MapInt32Double_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    tiledbPINVOKE.MapInt32Double_Clear(swigCPtr);
  }

  private double getitem(int key) {
    double ret = tiledbPINVOKE.MapInt32Double_getitem(swigCPtr, key);
    if (tiledbPINVOKE.SWIGPendingException.Pending) throw tiledbPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int key, double x) {
    tiledbPINVOKE.MapInt32Double_setitem(swigCPtr, key, x);
  }

  public bool ContainsKey(int key) {
    bool ret = tiledbPINVOKE.MapInt32Double_ContainsKey(swigCPtr, key);
    return ret;
  }

  public void Add(int key, double value) {
    tiledbPINVOKE.MapInt32Double_Add(swigCPtr, key, value);
    if (tiledbPINVOKE.SWIGPendingException.Pending) throw tiledbPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(int key) {
    bool ret = tiledbPINVOKE.MapInt32Double_Remove(swigCPtr, key);
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = tiledbPINVOKE.MapInt32Double_create_iterator_begin(swigCPtr);
    return ret;
  }

  private int get_next_key(global::System.IntPtr swigiterator) {
    int ret = tiledbPINVOKE.MapInt32Double_get_next_key(swigCPtr, swigiterator);
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    tiledbPINVOKE.MapInt32Double_destroy_iterator(swigCPtr, swigiterator);
  }
