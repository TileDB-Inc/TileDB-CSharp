...
public class FilterList : global::System.IDisposable {
  ...
  public SWIGTYPE_p_std__shared_ptrT_tiledb_filter_list_t_t ptr() {
    SWIGTYPE_p_std__shared_ptrT_tiledb_filter_list_t_t ret = new SWIGTYPE_p_std__shared_ptrT_tiledb_filter_list_t_t(tiledbcsPINVOKE.FilterList_ptr(swigCPtr), true);
    if (tiledbcsPINVOKE.SWIGPendingException.Pending) throw tiledbcsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
