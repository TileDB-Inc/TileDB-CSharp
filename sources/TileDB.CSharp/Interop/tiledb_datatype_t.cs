...
{
    [Obsolete(Obsoletions.TileDBInteropMessage + " Use the TileDB.CSharp.DataType type instead.", DiagnosticId = Obsoletions.TileDBInteropDiagId, UrlFormat = Obsoletions.SharedUrlFormat)]
