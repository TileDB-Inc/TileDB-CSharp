...
{
    [Obsolete(Obsoletions.TileDBInteropMessage + " Use the TileDB.CSharp.FilterType type instead.", DiagnosticId = Obsoletions.TileDBInteropDiagId, UrlFormat = Obsoletions.SharedUrlFormat)]
